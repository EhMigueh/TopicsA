...
plot "ddot.all.dat" using 1:2:xtic(1) notitle with linespoints
set size 0.5,0.5
set origin 0.5,0.5
...
plot "ddot.all.dat" using 1:5:xtic(1) notitle with linespoints
set size 0.5,0.5
set origin 0.0,0.0
...
plot "ddot.all.dat" using 1:6:xtic(1) notitle with linespoints
set size 0.5,0.5
set origin 0.5,0.0
...
plot "ddot.all.dat" using 1:7:xtic(1) notitle with linespoints
unset multiplot
set output
set terminal pop
